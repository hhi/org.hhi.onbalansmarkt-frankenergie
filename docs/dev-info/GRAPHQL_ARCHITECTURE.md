...
- **Berekend**: `siteReference` (formaat: "7609PA 31 B 1447720")
...
{
  "me": {
    "id": "clucw24l10h0qhj12m4gvw587",
    "email": "user@example.com",
    "connections": [
      {
        "id": "clucw2kiq02mohr12noqrb5dg",
        "connectionId": "c2aa0dc5-a27d-46e7-a650-b1420123063d",
        "EAN": "871691600019399731",
        "segment": "ELECTRICITY"
      }
    ]
  }
...
```json
{
  "smartBatteries": [
    {
      "id": "clvvf1ch800upc94qd1wxm5bk",
      "brand": "Sessy",
      "capacity": 5.2,
      "externalReference": "A7K5SCKD",
      "provider": "SESSY",
      "maxChargePower": 2.2,
...
{
  "smartBatterySessions": {
    "deviceId": "clvvf1ch800upc94qd1wxm5bk",
...
```json
{
  "smartPvSystems": [
    {
      "id": "cmd354tku000sz2jcm4ucucw4",
      "brand": "SolarEdge",
      "connectionEAN": "871691600019399731",
      "displayName": null,
      "externalReference": "48da3621-0525-4820-b303-31bb0f30de32_cec74d9c-78da-48a3-9187-9f4366369218",
      "inverterSerialNumbers": ["7B0637E9-A1"],
      "provider": "SOLAREDGE",
      "onboardingStatus": "ACTIVE",
...
{
  "periodUsageAndCosts": {
    "_id": "7609PA 31 B 1447720|2025-10",
    "electricity": {
      "usageTotal": 440.548,
      "costsTotal": 46.46,
      "unit": "KWH",
...
4. **Energie data** gebruikt `siteReference` afgeleid van connections
