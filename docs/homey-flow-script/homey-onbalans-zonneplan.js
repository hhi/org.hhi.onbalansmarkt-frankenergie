...
// haal alle data op
let dailyEarned = battery.capabilitiesObj['meter_power.daily_earned'].value;
let dailyImport = battery.capabilitiesObj['meter_power.daily_import'].value;
let dailyExport = battery.capabilitiesObj['meter_power.daily_export'].value

let totalEarned = battery.capabilitiesObj['meter_power.total_earned'].value;
let dynamicLoadBalancingActive = battery.capabilitiesObj['boolean.dynamicloadbalancingactive'].value;

let batteryCharge = battery.capabilitiesObj['measure_battery'].value;
let cycleCount = battery.capabilitiesObj['cycle_count'].value;
...
let lastMeasuredAt = battery.capabilitiesObj['lastmeasured'].value;
