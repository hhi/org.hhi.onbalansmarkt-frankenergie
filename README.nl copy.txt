Stuur live feedback van je actuele handelsresultaten die je met je thuisbatterijsysteem hebt behaalt bij Frank Energie (of Zonneplan) naar Onbalansmarkt.
...
- Hondelsresultaat en EPEX opbrengst 
- Lifetime totaal 
- slim korting 
...
Voeg als eerste device de Frank Energie Batteij (Slim laden) toe: 
...
via een actie (DAN) flow kaartje geef je per deelnemende batterij de gementen waarden door.
